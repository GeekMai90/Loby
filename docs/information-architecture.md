...
Nibva should manage writing work as projects, groups, and sheets, not as loose notes.
...
A library is a local folder that contains writing projects.
...
- Text: formal articles, chapters, sections, and publishable writing
- Materials: references, ideas, AI notes, image directions, and support content
...
- Material sheets stay in the same project but should not enter compiled exports by default.
