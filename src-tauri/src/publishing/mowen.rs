//! [INPUT]: 依赖发布 secret store/共享 payload、reqwest、serde_json、image 优化、临时目录与 Tauri IPC Channel
//! [OUTPUT]: 向 publishing command facade 提供 validate_api_key 与 publish_note 墨问发布流程
