...
//! [OUTPUT]: 向 crate 提供含文稿收藏与置顶状态且无文稿系统状态的写作库契约、单文稿保存回执、带输入指纹的发布记录、Agent Skill 诊断、含 Provider 能力声明和图片服务偏好的 runtime、带封闭 kind/sequence/权威生命周期的 Agent 事件及 publishing 等跨领域受控契约
