//! [INPUT]: 依赖 agent/ 下的 Provider、连接诊断、传输政策、流协议、文稿提案、凭证、联网搜索、图片生成、封面搜索词、MCP、工具、附件、会话、Skill、能力发现、事件、quick prompt 与 runtime 子模块
//! [OUTPUT]: 向 crate 提供 Loby-owned Agent Runtime、真实连接验证、具备有界重试与流空闲检测的 Provider、结构化提案、独立封面搜索词生成、自动搜索路由、图片 Provider、Tool/MCP/Skill 适配及会话附件持久化能力
...
pub(crate) mod image_search_query;
pub(crate) mod mcp;
