...
- Added a standalone AI-assisted WeChat theme studio with reusable personal themes, live article preview, safe manifest validation, automatic app-data persistence, per-theme conversations, and bounded undo/redo history.
