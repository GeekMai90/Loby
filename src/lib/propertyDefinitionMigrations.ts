import type { MetadataValue, ProjectPropertyDefinition, PropertyFieldType, PropertyOption, WritingSheet } from "../types";
import { nowTimestamp } from "./dates";
import { isEmptyMetadataValue } from "./documentProperties";
