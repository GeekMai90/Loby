/**
 * [INPUT]: 依赖 同目录稳定契约
 * [OUTPUT]: 对外提供含文稿收藏与置顶状态的写作契约、项目发布目标绑定、带发布输入指纹的 GitHub/微信公众号发布身份、侧边栏折叠模式、AI runtime、活动生命周期、AiAttachment、会话、正文审阅与应用设置等跨 feature 稳定契约
...
export type SidebarCollapseMode = "navigation-only" | "navigation-and-list";
