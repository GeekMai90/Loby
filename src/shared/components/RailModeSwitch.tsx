/**
 * [INPUT]: 依赖 clsx、lucide-react
 * [OUTPUT]: 对外提供 RailModeSwitch
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Folder className="rail-mode-icon" size={18} strokeWidth={2.1} aria-hidden="true" />
      </button>
      <button
        type="button"
      ...
      >
        <span className="rail-mode-dot" aria-hidden="true" />
        <FileText className="rail-mode-icon" size={18} strokeWidth={2.1} aria-hidden="true" />
      </button>
    </div>
  );
}
