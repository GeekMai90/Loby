...
import { isMacDesktopRuntime } from "@/shared/lib/platform";
...
export function EditorToolbar({
  ...
  const useNativeMacWindowDragRegion = isMacDesktopRuntime();
  ...
  return (
    <header
      ...
      data-tauri-drag-region={useNativeMacWindowDragRegion ? true : undefined}
      onMouseDown={useNativeMacWindowDragRegion ? undefined : onWindowDragStart}
      onDoubleClick={useNativeMacWindowDragRegion ? undefined : onWindowToolbarDoubleClick}
    >
      {!focusMode && (
