/**
 * [INPUT]: 依赖 lucide-react、React 运行时、shadcn/ui 基础控件、shared 公共契约、编辑器模块
 * [OUTPUT]: 对外提供 EditorSelectionToolbarSession、EditorSelectionToolbar
...
import type { MarkdownFormat } from "@/features/editor/model/editorMarkdown";
