/**
 * [INPUT]: 依赖 React 运行时、shared 公共契约、写作库模块、AI 助手模块
 * [OUTPUT]: 对外提供 useQuickPrompts
...
import { createQuickPrompt, MAX_AI_QUICK_PROMPTS, updateQuickPrompt } from "@/features/assistant/model/quickPrompts";
