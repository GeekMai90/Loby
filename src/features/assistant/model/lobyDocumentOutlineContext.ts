/**
 * [INPUT]: 依赖 shared 公共契约、AI 助手模块、编辑器模块
 * [OUTPUT]: 对外提供 buildLobyDocumentOutlineContext
 * [POS]: AI 助手 feature 的领域模型边界，集中 AI 助手 规则、数据转换与外部契约
 * [PROTOCOL]: 变更时更新此头部，然后检查 AGENTS.md
 */
import type { WritingSheet } from "@/shared/types";
import { collectMarkdownParagraphBlocks } from "@/features/assistant/model/aiInsertionTarget";
