/**
 * [INPUT]: 依赖 同目录稳定契约
 * [OUTPUT]: 对外提供 AiInsertionTarget、EditorInsertionRange、EditorInsertionRangeResult、AiInsertionAnchor、MarkdownParagraphBlock、normalizeAiInsertionTarget、resolveEditorInsertionRange、resolveFallbackInsertionRange 等公开能力
