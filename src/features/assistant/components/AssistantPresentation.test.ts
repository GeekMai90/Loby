...
import {
  nextWordCountMilestone,
  resolveAssistantGoalMotionState,
  WORD_COUNT_AUTO_REVEAL_DURATION_MS,
} from "@/features/assistant/model/assistantLauncher";
...
import { AssistantQuickPromptEmptyState } from "@/features/assistant/components/AssistantPanelChrome";
