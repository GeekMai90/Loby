...
} from "../../lib/publishing/wechatImageHost";
import { SettingsActionRow, SettingsRow, SettingsSection } from "./SettingsControls";
  ...
  return (
    <div className="flex flex-col gap-4.5">
      <SettingsSection title="微信公众号图床">
        ...
        />
        <SettingsRow label="Access Key Secret" description="密钥只交给 Nibva 桌面后端使用，不会写入文章或主题文件。">
          <Input
            className="max-w-70"
            type="password"
